...
import removeNonSignificantZeroBytes from 'src/features/data-availability/utils/remove-non-significant-zero-bytes';

import RawDataSnippet from 'src/shared/data/RawDataSnippet';
import bytesToBase64 from 'src/shared/data/transformers/bytes-to-base64';
