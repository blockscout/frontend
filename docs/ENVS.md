...
| Variable | Type | Description | Compulsoriness  | Default value | Example value | Version |
| --- | --- | --- | --- | --- | --- | --- |
| NEXT_PUBLIC_VIEWS_TOKEN_SCAM_TOGGLE_ENABLED | `boolean` | Show the "Hide scam tokens" toggler in the site settings dropdown. This controls the visibility of tokens with a poor reputation in the Tokens list and Token transfers views. | - | - | `'["value","tx_fee"]'` | v1.38.0+ |
