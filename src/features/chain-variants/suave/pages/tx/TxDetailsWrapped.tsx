...
import TxDetailsGasPrice from 'src/slices/tx/pages/details/info/parts/TxDetailsGasPrice';
import TxDetailsOther from 'src/slices/tx/pages/details/info/parts/TxDetailsOther';
