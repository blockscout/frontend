...
import JsonFileIcon from 'src/sprite/icons/files/json.svg';
import PlaceholderFileIcon from 'src/sprite/icons/files/placeholder.svg';
import SolFileIcon from 'src/sprite/icons/files/sol.svg';
import YulFileIcon from 'src/sprite/icons/files/yul.svg';
