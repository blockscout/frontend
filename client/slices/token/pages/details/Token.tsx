...
import TokenInventory from 'client/slices/token/pages/details/inventory/TokenInventory';
import TokenPageTitle from 'client/slices/token/pages/details/TokenPageTitle';
