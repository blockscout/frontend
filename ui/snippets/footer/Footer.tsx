...
const FRONT_VERSION_URL = `https://entrophyscan.com/`;
const FRONT_COMMIT_URL = `https://entrophyscan.com/`;
...
const Footer = () => {
  ...
  const apiVersionUrl =
    'https://entrophyscan.com/' ||
    getApiVersionUrl(backendVersionData?.backend_version);
  ...
  const BLOCKSCOUT_LINKS = [
    {
      ...
      url: 'https://entrophyscan.com/' || issueUrl,
    },
    {
      icon: 'social/canny' as const,
      iconSize: '20px',
      text: 'Feature request',
      url: 'https://entrophyscan.com/',
    },
    {
    ...
    },
    {
      ...
      iconSize: '18px',
      text: 'X (ex-Twitter)',
      url: 'https://www.twitter.com/entrophyscan',
    },
    {
      icon: 'social/discord' as const,
      iconSize: '24px',
      text: 'Discord',
      url: 'https://discord.gg/entrophyscan',
    },
    {
      icon: 'discussions' as const,
      iconSize: '20px',
      text: 'Discussions',
      url: 'https://github.com/orgs/entrophyscan/discussions',
    },
    {
      icon: 'donate' as const,
      iconSize: '20px',
      text: 'Donate',
      url: 'https://github.com/sponsors/entrophyscan',
    },
  ];
    ...
    (gridArea?: GridProps['gridArea']) => {
      return (
        <Box gridArea={ gridArea }>
          <Link fontSize="xs" href="https://entrophyscan.com/">
            https://entrophyscan.com/
          </Link>
          <Text mt={ 3 } fontSize="xs">
            Entrophyscan is a tool for inspecting and analyzing ENTROPHY based
            blockchains. Blockchain explorer for Entrophy Networks.
          </Text>
