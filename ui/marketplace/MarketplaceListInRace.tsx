...
const MarketplaceListInRace = ({ apps, showAppInfo, favoriteApps, onFavoriteClick, isLoading, selectedCategoryId, onAppClick }: Props) => {
...
export default React.memo(MarketplaceListInRace);
