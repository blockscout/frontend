...
const BlobInfo = ({ data, isLoading }: Props) => {
  return (
    <Grid columnGap={8} rowGap={3} templateColumns={{ base: "minmax(0, 1fr)", lg: "216px minmax(728px, auto)" }}>
      {!data.blob_data && (
      ...
      {data.kzg_commitment && (
        <>
          <DetailsInfoItem.Label hint="Commitment to the data in the blob" isLoading={isLoading}>
            Commitment
          </DetailsInfoItem.Label>
          <DetailsInfoItem.Value>
            <Skeleton
      ...
      {data.blob_data && (
        <>
          <DetailsInfoItem.Label hint="Blob size in bytes" isLoading={isLoading}>
            Size, bytes
          </DetailsInfoItem.Label>
          <DetailsInfoItem.Value>
      ...
      {data.transaction_hashes[0] && (
        <>
          <DetailsInfoItem.Label hint="Hash of the transaction with this blob" isLoading={isLoading}>
            Transaction hash
          </DetailsInfoItem.Label>
          <DetailsInfoItem.Value>
