...
import { publicTagTypes as configMock } from 'src/features/address-metadata/mocks/tag-types';

import { base as useInfoMock } from 'src/features/account/mocks/user-profile';
