...
import type { TContractAutoVerificationStatus } from 'src/slices/contract/pages/details/code/ContractAutoVerificationStatus';
import ContractAutoVerificationStatus from 'src/slices/contract/pages/details/code/ContractAutoVerificationStatus';
import useContractTabs from 'src/slices/contract/pages/details/useContractTabs';
...
import type { Props as RoutedTabsProps } from 'src/toolkit/components/AdaptiveTabs/AdaptiveTabs';
