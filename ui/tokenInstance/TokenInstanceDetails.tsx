      ...
      <Flex alignItems="flex-start" flexDir={{ base: "column-reverse", lg: "row" }} columnGap={6} rowGap={6}>
        ...
        >
          {data.is_unique && data.owner && (
            <>
              <DetailsInfoItem.Label hint="Current owner of this token instance" isLoading={isLoading}>
                Owner
          ...
          <DetailsInfoItem.Label hint="This token instance unique token ID" isLoading={isLoading}>
            Token ID
          </DetailsInfoItem.Label>
          <DetailsInfoItem.Value>
