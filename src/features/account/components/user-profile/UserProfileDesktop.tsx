...
import UserProfileAuth0 from 'src/features/account/components/user-profile/auth0/UserProfileDesktop';
import UserWalletDesktop from 'src/features/account/components/user-profile/wallet/UserWalletDesktop';
