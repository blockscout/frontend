...
const ChartLineLoader = ({ className }: { className?: string }) => {
  ...
  const lineBgColor = useToken('colors', useColorModeValue('gray.200', colors.grayTrue[500])); //'gray.500'
  const lineFgColor = useToken('colors', useColorModeValue('gray.400', colors.grayTrue[300])); //'gray.300'
