...
| NEXT_PUBLIC_NETWORK_ADDITIONAL_TOKEN_TYPES | `Array<{id: string; name: string; isNFT?: boolean; hasValue?: boolean; hasIds?: boolean;}>` | List of additional token types supported by the explorer UI (extends token type filters/labels). | - | `[]` | `'[{"id":"ERC-404","name":"ERC-404","hasValue":true}]'` | v2.6.0+ |
