...
| Property | Type | Description | Compulsoriness | Example value |
| --- | --- | --- | --- | --- |
| swap | `{ chains: Array<string>, fee: string, integrator: string }` | Swap config for the LI.FI-hosted widget. The legacy `url` property is ignored. | - | `{'chains': ['1'], 'fee': '0.004', 'integrator': 'blockscout'}` |
