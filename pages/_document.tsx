    ...
    return (
      <Html lang="en">
        <Head>
          ...
          { /* FAVICON */ }
          <link rel="icon" type="image/png" sizes="16x16" href="/assets/favicon/favicon-white.png"/>
          <link rel="icon" type="image/png" sizes="32x32" href="/assets/favicon/favicon-white.png"/>
          <link rel="icon" type="image/png" sizes="48x48" href="/assets/favicon/favicon-white.png"/>
          <link rel="apple-touch-icon" sizes="180x180" href="/assets/favicon/favicon-white.png"/>
          <link rel="icon" type="image/png" sizes="192x192" href="/assets/favicon/favicon-white.png"/>
