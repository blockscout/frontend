    ...
    switch (statusCode) {
      case 429: {
        ...
        const bypassOptions =
          ...
          rateLimits &&
          "bypassOptions" in rateLimits
            ? rateLimits.bypassOptions
            : undefined;
        const reset =
          typeof rateLimits === "object" && rateLimits && "reset" in rateLimits
            ? rateLimits.reset
            : undefined;
        return (
          <AppErrorTooManyRequests
            bypassOptions={
              typeof bypassOptions === "string" ? bypassOptions : undefined
            }
