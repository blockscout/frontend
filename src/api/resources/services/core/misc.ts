...
R extends 'core:stats' ? paths['/api/v2/stats']['get'] :
R extends 'core:stats_charts_txs' ? paths['/api/v2/stats/charts/transactions']['get'] :
R extends 'core:stats_charts_market' ? paths['/api/v2/stats/charts/market']['get'] :
R extends 'core:stats_charts_secondary_coin_price' ? paths['/api/v2/stats/charts/secondary-coin-market']['get'] :
R extends 'core:stats_hot_contracts' ? paths['/api/v2/stats/hot-smart-contracts']['get'] :
R extends 'core:homepage_blocks' ? paths['/api/v2/main-page/blocks']['get'] :
R extends 'core:homepage_txs' ? paths['/api/v2/main-page/transactions']['get'] :
R extends 'core:homepage_txs_watchlist' ? paths['/api/v2/main-page/transactions/watchlist']['get'] :
R extends 'core:homepage_optimistic_deposits' ? paths['/api/v2/main-page/optimism-deposits']['get'] :
R extends 'core:homepage_arbitrum_deposits' ? paths['/api/v2/main-page/arbitrum/messages/to-rollup']['get'] :
R extends 'core:homepage_arbitrum_l2_batches' ? paths['/api/v2/main-page/arbitrum/batches/committed']['get'] :
R extends 'core:homepage_indexing_status' ? paths['/api/v2/main-page/indexing-status']['get'] :
R extends 'core:homepage_zksync_latest_batch' ? number :
R extends 'core:homepage_arbitrum_latest_batch' ? paths['/api/v2/main-page/arbitrum/batches/latest-number']['get'] :
R extends 'core:quick_search' ? QuickSearchResult :
R extends 'core:search' ? SearchResult :
R extends 'core:search_check_redirect' ? paths['/api/v2/search/check-redirect']['get'] :
R extends 'core:config_backend' ? paths['/api/v2/config/backend']['get'] :
R extends 'core:config_backend_version' ? paths['/api/v2/config/backend-version']['get'] :
R extends 'core:config_csv_export' ? paths['/api/v2/config/csv-export']['get'] :
R extends 'core:config_celo' ? paths['/api/v2/config/celo']['get'] :
R extends 'core:config_contract_languages' ? paths['/api/v2/config/smart-contracts/languages']['get'] :
...
R extends 'core:validators_zilliqa' ? paths['/api/v2/validators/zilliqa']['get'] :
R extends 'core:validator_zilliqa' ? paths['/api/v2/validators/zilliqa/{bls_public_key}']['get'] :
R extends 'core:epochs_celo' ? paths['/api/v2/celo/epochs']['get'] :
R extends 'core:epoch_celo' ? paths['/api/v2/celo/epochs/{number}']['get'] :
R extends 'core:epoch_celo_election_rewards' ? paths['/api/v2/celo/epochs/{number}/election-rewards/{type}']['get'] :
R extends 'core:user_ops' ? paths['/api/v2/proxy/account-abstraction/operations']['get'] :
R extends 'core:user_op' ? paths['/api/v2/proxy/account-abstraction/operations/{operation_hash_param}']['get'] :
R extends 'core:user_ops_account' ? paths['/api/v2/proxy/account-abstraction/accounts/{address_hash_param}']['get'] :
...
R extends 'core:withdrawals' ? paths['/api/v2/withdrawals']['get'] :
R extends 'core:withdrawals_counters' ? paths['/api/v2/withdrawals/counters']['get'] :
R extends 'core:deposits' ? paths['/api/v2/beacon/deposits']['get'] :
R extends 'core:deposits_counters' ? paths['/api/v2/beacon/deposits/count']['get'] :
R extends 'core:advanced_filter' ? paths['/api/v2/advanced-filters']['get'] :
R extends 'core:advanced_filter_methods' ? paths['/api/v2/advanced-filters/methods']['get'] :
R extends 'core:csv_exports_item' ? paths['/api/v2/csv-exports/{uuid_param}']['get'] :
never;
