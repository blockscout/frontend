...
export const PAGE_TYPE_DICT: Record<Route['pathname'], string> = {
  ...
  '/all-validators': 'All validators list',
  '/validator-detail/[addr]': 'Validator detail',
  ...
  '/api/auth/callback/discord': 'Node API: Discord auth',
  '/api/auth/session': 'Node API: Session',
