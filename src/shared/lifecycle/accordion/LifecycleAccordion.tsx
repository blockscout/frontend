...
import type { AccordionItemContentProps } from 'src/toolkit/chakra/accordion';
import { AccordionItem, AccordionItemContent, AccordionItemTrigger, AccordionRoot } from 'src/toolkit/chakra/accordion';
