...
const NavLink = ({ text, url, icon, isCollapsed, isActive, px }: Props) => {
  ...
  return (
    <Box as="li" listStyleType="none" w="100%">
      ...
      { /* why not NextLink? since prev UI and new one are hosting in the same domain and global routing is managed by nginx */ }
      { /* we have to hard reload page on every transition between urls */ }
      <Link
        href={ url }
