...
const NavigationDesktop = () => {
  ...
  const hasAccount = Boolean(appConfig.isAccountSupported && isAuth);
  const [ isCollapsed, setCollapsedState ] = React.useState<boolean | undefined>(navBarCollapsedCookie === 'true');
