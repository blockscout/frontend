...
import { VIA_L2_TX_BATCH_STATUSES, type ViaBatch } from 'types/api/viaL2';
...
import ViaL2TxnBatchHashesInfo from './ViaL2TxnBatchHashesInfo';

interface Props {
  query: UseQueryResult<ViaBatch, ResourceError>;
}

const ViaL2TxnBatchDetails = ({ query }: Props) => {
  ...
  return (
    ...
    >
      ...
      <DetailedInfo.ItemValue>
        <VerificationSteps steps={ VIA_L2_TX_BATCH_STATUSES.slice(1) } currentStep={ data.status } isLoading={ isPlaceholderData }/>
      </DetailedInfo.ItemValue>
      ...
      <ViaL2TxnBatchHashesInfo isLoading={ isPlaceholderData } data={ data }/>
...
export default ViaL2TxnBatchDetails;
