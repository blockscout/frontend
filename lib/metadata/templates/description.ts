...
const DEFAULT_TEMPLATE = ' Discover the Game7 Chain with our blockchain explorer. Access real-time data on transactions, blocks, and smart contracts to stay informed on the Game7 ecosystem.';
