...
- [x] None of the files in Details holds `useState` for a filter value the URL carries, nor a
...
- [x] `(human)` Address token transfers: type filter and from/to filter reset to page 1 and survive
