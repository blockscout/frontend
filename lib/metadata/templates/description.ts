...
const DEFAULT_TEMPLATE = 'Explore the first extensible Layer1 blockchain with parallel execution and modular VMs.';
...
const TEMPLATE_MAP: Record<Route['pathname'], string> = {
  ...
  '/aspect/[hash]': 'View the aspect detail, transactions, and other data for %hash% on the %network_title%',
