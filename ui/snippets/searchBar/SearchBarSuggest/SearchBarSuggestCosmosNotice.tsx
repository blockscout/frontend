...
const SearchBarSuggestCosmosNotice = ({ cosmosHash, type }: Props) => {
  ...
  return (
    <>
      <Text color="text.secondary">
        It looks like you are searching for a Cosmos SDK style hash. This information is best served by the MintScan explorer.
      </Text>
...
export default React.memo(SearchBarSuggestCosmosNotice);
