...
const InteropMessages = () => {
  const interopMessagesQuery = useQueryWithPages({
    resourceName: 'interop_messages',
    options: {
      placeholderData: generateListStub<'interop_messages'>(INTEROP_MESSAGE, 50, { next_page_params: {
  ...
  const countQuery = useApiQuery('interop_messages_count', {
    queryOptions: {
