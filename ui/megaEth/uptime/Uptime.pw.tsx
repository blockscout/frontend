...
const HISTORY_DELTA_DATA = {
  data: {
    historical_gas_per_second_3h: { timestamp: Date.now() / SECOND, value: 87762230 },
    historical_tps_3h: { timestamp: Date.now() / SECOND, value: 211.8 },
    historical_mini_block_interval_3h: { timestamp: Date.now() / SECOND, value: 10.593221 },
  },
  type: 'history_delta',
};
