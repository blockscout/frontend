...
export const tokenHoldersERC20: paths['/api/v2/tokens/{address_hash_param}/holders']['get'] = {
  items: [
    {
      address: withName,
...
export const tokenHoldersERC1155: paths['/api/v2/tokens/{address_hash_param}/holders']['get'] = {
  items: [
    {
      address: withName,
      value: '107014805905725000000',
