...
const RESTRICTED_MODULES = {
  paths: [
    { name: 'dayjs', message: 'Please use client/shared/date-and-time/dayjs.ts instead of directly importing dayjs' },
      ...
      'import-helpers/order-imports': [
        'error',
        {
          ...
          groups: [
            ...
            [ '/^client/slices/' ],
            [ '/^client/features/' ],
            [ '/^client/config/', '/^client/services/', '/^client/shared/', '/^client/sprite/' ],
            [ '/^client/toolkit/' ],
            [
              '/^configs/',
              '/^data/',
