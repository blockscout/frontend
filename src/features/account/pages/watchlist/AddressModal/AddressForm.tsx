...
import type { WatchlistAddress, WatchlistErrors } from 'src/features/account/types/api';
...
import { FormFieldAddress } from 'src/toolkit/components/forms/fields/FormFieldAddress';
...
const AddressForm: React.FC<Props> = ({ data, onSuccess, setAlertVisible, isAdd, hasEmail, showEmailAlert }) => {
  ...
  function updateWatchlist(formData: Inputs) {
    ...
    if (!isAdd && data) {
      // edit address
      return apiFetch('core:watchlist', {
      ...
      // add address
      return apiFetch('core:watchlist', { fetchParams: { method: 'POST', body } });
    }
  }
