import type { AddressValidationResponseSuccess } from 'client/features/account/pages/verified-addresses/address-verification/types';
import type { TokenInfoApplication, TokenInfoApplications, VerifiedAddress, VerifiedAddressResponse } from 'client/features/account/types/api';
