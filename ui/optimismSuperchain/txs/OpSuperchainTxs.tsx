...
import OpSuperchainTxsLocal, {
  OP_SUPERCHAIN_TXS_LOCAL_TAB_IDS,
} from "./OpSuperchainTxsLocal";
...
const OpSuperchainTxs = () => {
  ...
  const chainSelect = useRoutedChainSelect({
    persistedParams: QUERY_PRESERVED_PARAMS,
  });

  const tab = getQueryParamString(router.query.tab);
  const isLocalTxs =
    tab === "txs_local" || OP_SUPERCHAIN_TXS_LOCAL_TAB_IDS.includes(tab);
