...
const ActivityListTable = (props: {
    ...
    const tableHeaders = (
        <Tr>
            <CustomTableHeader width='300px'>Txn Hash</CustomTableHeader>
            <CustomTableHeader>Activity</CustomTableHeader>
            <CustomTableHeader>Amount</CustomTableHeader>
            <CustomTableHeader>From</CustomTableHeader>
            <CustomTableHeader>To</CustomTableHeader>
            <CustomTableHeader>Date</CustomTableHeader>
        </Tr>
    );
