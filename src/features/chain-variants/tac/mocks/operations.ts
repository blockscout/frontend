...
export const tacOperation: tac.V2OperationDetails = {
  ...
  status_history: [
    {
      type: tac.V2OperationStage_V2StageType.COLLECTED_IN_TON,
      is_exist: true,
      is_success: true,
      timestamp: '2025-05-08T07:20:05.000Z',
      transactions: [
        {
          ...
          type: tac.V2BlockchainType.TON,
        },
      ],
      note: undefined,
    },
    {
      type: tac.V2OperationStage_V2StageType.INCLUDED_IN_TON_CONSENSUS,
      is_exist: true,
      is_success: true,
    ...
    {
      type: tac.V2OperationStage_V2StageType.EXECUTED_IN_TON,
      is_exist: true,
      is_success: false,
