    ...
    >
      <InputGroup size={{ base: 'sm', lg: isHomepage ? 'sm_md' : 'sm' }} >
        ...
        <Input
          ...
          placeholder={ isMobile ? 'Search by block / ... ' : 'Search by block / txn / address / bucket / object... ' }
...
export default React.memo(forwardRef(SearchBarInputStorage));
