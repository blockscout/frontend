...
import type { SmartContractMudSystemItem } from 'src/features/chain-variants/mud/types/api';

import useApiQuery from 'src/api/hooks/useApiQuery';

import type { Item } from 'src/slices/contract/pages/details/code/ContractSourceAddressSelector';
import ContractSourceAddressSelector from 'src/slices/contract/pages/details/code/ContractSourceAddressSelector';
import ContractAbi from 'src/slices/contract/pages/details/methods/ContractAbi';
import ContractMethodsAlerts from 'src/slices/contract/pages/details/methods/ContractMethodsAlerts';
import ContractMethodsContainer from 'src/slices/contract/pages/details/methods/ContractMethodsContainer';
import ContractMethodsFilters from 'src/slices/contract/pages/details/methods/ContractMethodsFilters';
import useMethodsFilters from 'src/slices/contract/pages/details/methods/useMethodsFilters';
import { formatAbi } from 'src/slices/contract/pages/details/methods/utils';
...
const ContractMethodsMudSystem = ({ items }: Props) => {
  ...
  const systemInfoQuery = useApiQuery('core:mud_system_info', {
