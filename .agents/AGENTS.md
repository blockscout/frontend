...
before sending anything — unless the skill you are running names an explicit exception. Before composing
any Slack message, read `./slack-message.md` (language, addressing, links, attribution).
