...
export const tokenInfoERC20a: TokenInfo<'DRC-20'> = {
...
export const tokenInfoERC20b: TokenInfo<'DRC-20'> = {
...
export const tokenInfoERC20c: TokenInfo<'DRC-20'> = {
...
export const tokenInfoERC20d: TokenInfo<'DRC-20'> = {
...
export const tokenInfoERC20LongSymbol: TokenInfo<'DRC-20'> = {
...
export const tokenInfoERC721a: TokenInfo<'DRC-721'> = {
...
export const tokenInfoERC721b: TokenInfo<'DRC-721'> = {
...
export const tokenInfoERC721c: TokenInfo<'DRC-721'> = {
...
export const tokenInfoERC721LongSymbol: TokenInfo<'DRC-721'> = {
...
export const tokenInfoERC1155a: TokenInfo<'DRC-1155'> = {
...
export const tokenInfoERC1155b: TokenInfo<'DRC-1155'> = {
...
export const tokenInfoERC1155WithoutName: TokenInfo<'DRC-1155'> = {
...
export const tokenInfoERC404: TokenInfo<'DRC-404'> = {
...
export const bridgedTokenA: TokenInfo<'DRC-20'> = {
  ...tokenInfoERC20a,
  is_bridged: true,
  origin_chain_id: '1',
  bridge_type: 'omni',
...
export const bridgedTokenB: TokenInfo<'DRC-20'> = {
  ...tokenInfoERC20b,
  is_bridged: true,
  origin_chain_id: '56',
  bridge_type: 'omni',
...
export const bridgedTokenC: TokenInfo<'DRC-20'> = {
  ...tokenInfoERC20d,
  is_bridged: true,
  origin_chain_id: '99',
  bridge_type: 'amb',
