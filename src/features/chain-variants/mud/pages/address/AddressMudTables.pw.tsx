...
import { mudTables } from 'src/features/chain-variants/mud/mocks/mud-tables';
...
test('base view +@mobile', async({ render, mockApiResponse }) => {
  await mockApiResponse('core:mud_tables', mudTables, { pathParams: { hash: ADDRESS_HASH }, queryParams: { q: 'o' } });
