...
import type { UptimeHistoryFull, UptimeHistoryItem } from 'src/features/chain-variants/mega-eth/types/api';
import type { LineChartAxesConfigFn } from 'src/toolkit/components/charts/line/types';
...
import { DAY, HOUR, SECOND } from 'src/toolkit/utils/consts';
