...
| NEXT_PUBLIC_GAS_TRACKER_PREFERRED_UNITS | `usd` \| `gwei` | Preferred units for displaying gas prices on the Gas Tracker page, in the stats snippet on the Home page, and in the top bar.  | - | `usd` | `gwei` |
