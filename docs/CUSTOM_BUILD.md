...
You are free to clone the repo and make any changes to the application code that you want, adding your own customization and features. After that you can build a docker image by running `pnpm build:docker` or alternatively run `docker build` and pass your own args that is necessary.
