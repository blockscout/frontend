...
import type { ZetaChainCCTXFilterParams, ZetaChainTokenInfo } from 'types/api/zetaChain';
...
const ZetaChainAssetFilter = ({ value = [], handleFilterChange }: Props) => {
  ...
  const onTokenClick = React.useCallback((token: ZetaChainTokenInfo | TokenInfo) => () => {
