...
R extends 'core:optimistic_l2_output_roots' ? paths['/v2/optimism/output-roots']['get'] :
R extends 'core:optimistic_l2_output_roots_count' ? paths['/v2/optimism/output-roots/count']['get'] :
R extends 'core:optimistic_l2_withdrawals' ? paths['/v2/optimism/withdrawals']['get'] :
R extends 'core:optimistic_l2_withdrawals_count' ? paths['/v2/optimism/withdrawals/count']['get'] :
R extends 'core:optimistic_l2_deposits' ? paths['/v2/optimism/deposits']['get'] :
R extends 'core:optimistic_l2_deposits_count' ? paths['/v2/optimism/deposits/count']['get'] :
R extends 'core:optimistic_l2_txn_batches' ? paths['/v2/optimism/batches']['get'] :
R extends 'core:optimistic_l2_txn_batches_count' ? paths['/v2/optimism/batches/count']['get'] :
R extends 'core:optimistic_l2_txn_batch' ? paths['/v2/optimism/batches/{number}']['get'] :
R extends 'core:optimistic_l2_txn_batch_celestia' ? paths['/v2/optimism/batches/da/celestia/{height}/{commitment}']['get'] :
...
R extends 'core:optimistic_l2_dispute_games' ? paths['/v2/optimism/games']['get'] :
R extends 'core:optimistic_l2_dispute_games_count' ? paths['/v2/optimism/games/count']['get'] :
...
R extends 'core:arbitrum_l2_messages' ? paths['/v2/arbitrum/messages/{direction}']['get'] :
R extends 'core:arbitrum_l2_messages_count' ? paths['/v2/arbitrum/messages/{direction}/count']['get'] :
R extends 'core:arbitrum_l2_txn_batches' ? paths['/v2/arbitrum/batches']['get'] :
R extends 'core:arbitrum_l2_txn_batches_count' ? paths['/v2/arbitrum/batches/count']['get'] :
R extends 'core:arbitrum_l2_txn_batch' ? paths['/v2/arbitrum/batches/{batch_number}']['get'] :
R extends 'core:arbitrum_l2_txn_batch_celestia' ? paths['/v2/arbitrum/batches/da/celestia/{height}/{transaction_commitment}']['get'] :
...
R extends 'core:arbitrum_l2_txn_withdrawals' ? paths['/v2/arbitrum/messages/withdrawals/{transaction_hash}']['get'] :
R extends 'core:arbitrum_l2_message_claim' ? paths['/v2/arbitrum/messages/claim/{message_id}']['get'] :
...
R extends 'core:scroll_l2_txn_batches' ? paths['/v2/scroll/batches']['get'] :
R extends 'core:scroll_l2_txn_batches_count' ? paths['/v2/scroll/batches/count']['get'] :
R extends 'core:scroll_l2_txn_batch' ? paths['/v2/scroll/batches/{number}']['get'] :
R extends 'core:scroll_l2_deposits' ? paths['/v2/scroll/deposits']['get'] :
R extends 'core:scroll_l2_deposits_count' ? paths['/v2/scroll/deposits/count']['get'] :
R extends 'core:scroll_l2_withdrawals' ? paths['/v2/scroll/withdrawals']['get'] :
R extends 'core:scroll_l2_withdrawals_count' ? paths['/v2/scroll/withdrawals/count']['get'] :
never;
